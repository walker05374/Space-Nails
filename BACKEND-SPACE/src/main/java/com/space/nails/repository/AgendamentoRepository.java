...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Long> {
    ...
    List<Agendamento> findParaNotificar24h(@Param("agora") LocalDateTime agora, @Param("amanha") LocalDateTime amanha);
    ...
    List<Agendamento> findParaNotificar2h(@Param("agora") LocalDateTime agora, @Param("daquiDuasHoras") LocalDateTime daquiDuasHoras);
    ...
    List<Agendamento> findParaNotificar30min(@Param("agora") LocalDateTime agora, @Param("daquiMeiaHora") LocalDateTime daquiMeiaHora);
    ...
    boolean existeConflitoHorario(@Param("profissional") Usuario profissional, @Param("dataHora") LocalDateTime dataHora);
}